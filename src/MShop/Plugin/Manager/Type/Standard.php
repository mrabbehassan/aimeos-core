	...
	implements \Aimeos\MShop\Plugin\Manager\Type\Iface
{
	 ...
	 *
	 * @see mshop/plugin/manager/type/insert/ansi
	 */
	 ...
	 * @since 2015.10
	 * @see mshop/plugin/manager/type/update/ansi
	 * @see mshop/plugin/manager/type/newid/ansi
	 * @see mshop/plugin/manager/type/delete/ansi
	 * @see mshop/plugin/manager/type/search/ansi
	 * @see mshop/plugin/manager/type/count/ansi
	 */
