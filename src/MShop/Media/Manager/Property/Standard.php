...
/**
 * Default media property manager implementation.
 *
 * @package MShop
 * @subpackage Media
 */
class Standard
	...
	implements \Aimeos\MShop\Media\Manager\Property\Iface
{
	 ...
	 * @see mshop/media/manager/property/decorators/local
	 */
	 ...
	 * @since 2018.01
	 * @see mshop/common/manager/decorators/default
	 * @see mshop/media/manager/property/decorators/excludes
	 * @see mshop/media/manager/property/decorators/local
	 */
	 ...
	 *
	 * @see mshop/media/manager/property/insert/ansi
	 */
	 ...
	 * @since 2018.01
	 * @see mshop/media/manager/property/update/ansi
	 * @see mshop/media/manager/property/newid/ansi
	 * @see mshop/media/manager/property/delete/ansi
	 * @see mshop/media/manager/property/search/ansi
	 * @see mshop/media/manager/property/count/ansi
	 */
