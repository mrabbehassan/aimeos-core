	...
	implements \Aimeos\MShop\Media\Manager\Lists\Iface
{
	 ...
	 *
	 * @see mshop/media/manager/lists/insert/ansi
	 */
	 ...
	 * @since 2015.10
	 * @see mshop/media/manager/lists/update/ansi
	 * @see mshop/media/manager/lists/newid/ansi
	 * @see mshop/media/manager/lists/delete/ansi
	 * @see mshop/media/manager/lists/search/ansi
	 * @see mshop/media/manager/lists/count/ansi
	 */
