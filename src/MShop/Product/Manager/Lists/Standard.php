...
class Standard
	...
	implements \Aimeos\MShop\Product\Manager\Lists\Iface
{
	 ...
	 *
	 * @see mshop/product/manager/lists/insert/ansi
	 */
	 ...
	 * @since 2015.10
	 * @see mshop/product/manager/lists/update/ansi
	 * @see mshop/product/manager/lists/newid/ansi
	 * @see mshop/product/manager/lists/delete/ansi
	 * @see mshop/product/manager/lists/search/ansi
	 * @see mshop/product/manager/lists/count/ansi
	 * @see mshop/product/manager/lists/aggregate/ansi
	 */
