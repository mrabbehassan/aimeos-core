	...
	implements \Aimeos\MShop\Supplier\Manager\Lists\Iface
{
	 ...
	 *
	 * @see mshop/supplier/manager/lists/insert/ansi
	 */
	 ...
	 * @since 2015.10
	 * @see mshop/supplier/manager/lists/update/ansi
	 * @see mshop/supplier/manager/lists/newid/ansi
	 * @see mshop/supplier/manager/lists/delete/ansi
	 * @see mshop/supplier/manager/lists/search/ansi
	 * @see mshop/supplier/manager/lists/count/ansi
	 * @see mshop/supplier/manager/lists/aggregate/ansi
	 */
