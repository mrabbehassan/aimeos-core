	...
	implements \Aimeos\MShop\Price\Manager\Lists\Iface
{
	 ...
	 *
	 * @see mshop/price/manager/lists/insert/ansi
	 */
	 ...
	 * @since 2015.10
	 * @see mshop/price/manager/lists/update/ansi
	 * @see mshop/price/manager/lists/newid/ansi
	 * @see mshop/price/manager/lists/delete/ansi
	 * @see mshop/price/manager/lists/search/ansi
	 * @see mshop/price/manager/lists/count/ansi
	 */
