	...
	extends \Aimeos\MShop\Common\Item\Iface, \Aimeos\MShop\Common\Item\TypeRef\Iface
{
	 ...
	 * Sets the base ID.
	 *
	 * @param string $parentid|null New base ID
	 * @return static Order base product item for chaining method calls
	 */
	 ...
	 * @return static Order base product item for chaining method calls
	 */
	public function setQuantity( float $quantitiy ) : static;
	 ...
	 * @return static Order base product item for chaining method calls
	 */
	public function setQuantityOpen( float $quantitiy ) : static;
	 ...
	 * @return static Order base product item for chaining method calls
	 */
	public function setScale( float $quantitiy ) : static;
	 ...
	 * @param string $code Code of the product attribute item
	 * @param array|string $type Type or list of types of the product attribute items
	 * @return \Aimeos\MShop\Order\Item\Product\Attribute\Iface|array|null Attribute item for the ordered product and the given code
	 */
